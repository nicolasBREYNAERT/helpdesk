...
<div class="container">
	<div class="table">
		<table>
			<tr><td colspan="2"><a class="btn btn-primary precedent" href=<?php echo "faqs/contenu/".$a?>>Precedent</a>&nbsp;<a class="btn btn-primary suivant" href=<?php echo "faqs/contenu/".$b?>>Suivant</a><td></tr>
